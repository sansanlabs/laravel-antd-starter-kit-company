...
import { Button, Descriptions, DescriptionsProps, Dropdown, Modal, Typography } from "antd";
...
export default function Index({ queryResult }: IndexType) {
  ...
  return (
    <DashboardLayout
      title={__(locale, "lang.user_activity_logs")}
      activeMenu="user-activity-logs"
      breadcrumb={[
        {
          title: __(locale, "lang.user_activity_logs"),
        },
      ]}
      extra={<InputSearchDatatable queryResult={queryResult} route={route("user-activity-logs.index")} />}
    >
      <Datatable
        queryResult={queryResult}
        route={route("user-activity-logs.index")}
